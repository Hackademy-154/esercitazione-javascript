...
//         alert('non è tantop il freddo quanto l\ umidità')
//     }
...
// console.log(num2)
// console.log(`la media dei numeri dispari è ${num2/count}`);
...
// se inserisce qualcosa dei diverso, il programma dovra’ riproporre automaticamente la domanda di partenza


do{
     let num =parseInt(prompt('che bevanda vuoi?/n1.acqua/n2.coca cola/n3.birra'))
    switch(num){
        case 1:
